...
void potentialSourcesInit(struct objPotentialSources *myPotentialSources, struct ParametersStruct *myParameters)
{
    ...
    ***************************************************************************/
    ...
    myPotentialSources->frequency = 0;
}
...
float potentialSourceGetFrequency(struct objPotentialSources *myPotentialSource)
{
    return myPotentialSource->frequency * ((float)GLOBAL_FS / (float)GLOBAL_FRAMESIZE) ;
}
