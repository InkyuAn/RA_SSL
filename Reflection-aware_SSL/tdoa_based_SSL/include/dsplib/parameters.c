                    ...
                    // +-------------------------------------------------------+
                            ...
                            parametersStruct->P_GEO_MICS_MIC1_GAIN = 1.0000f;
                                ...
                                // +-------------------------------------------+
                                        ...
                                        parametersStruct->P_GEO_MICS_MIC1_X = +0.2145f;
                                        parametersStruct->P_GEO_MICS_MIC1_Y = -0.1790f;
                                        parametersStruct->P_GEO_MICS_MIC1_Z = +0.1885f;
                                        //parametersStruct->P_GEO_MICS_MIC1_X = +0.2145f;
                                        //parametersStruct->P_GEO_MICS_MIC1_Y = +0.1790f;
                                        //parametersStruct->P_GEO_MICS_MIC1_Z = +0.1885f;
                    ...
                    // +-------------------------------------------------------+
                            ...
                            parametersStruct->P_GEO_MICS_MIC2_GAIN = 1.0000f;
                                ...
                                // +-------------------------------------------+
                                        ...
                                        // Define the position of each microphone on the cube (in meters)
                                        // The center of the cube is at the origin
                                        parametersStruct->P_GEO_MICS_MIC2_X = -0.2145f;
                                        parametersStruct->P_GEO_MICS_MIC2_Y = -0.1790f;
                                        parametersStruct->P_GEO_MICS_MIC2_Z = +0.1885f;
                                        //parametersStruct->P_GEO_MICS_MIC2_X = -0.2145f;
                                        //parametersStruct->P_GEO_MICS_MIC2_Y = +0.1790f;
                                        //parametersStruct->P_GEO_MICS_MIC2_Z = +0.1885f;
                    ...
                    // +-------------------------------------------------------+
                            ...
                            parametersStruct->P_GEO_MICS_MIC3_GAIN = 1.0000f;
                                ...
                                // +-------------------------------------------+
                                        ...
                                        // Define the position of each microphone on the cube (in meters)
                                        // The center of the cube is at the origin
                                        parametersStruct->P_GEO_MICS_MIC3_X = -0.2145f;
                                        parametersStruct->P_GEO_MICS_MIC3_Y = +0.1790f;
                                        parametersStruct->P_GEO_MICS_MIC3_Z = +0.1885f;
                                        //parametersStruct->P_GEO_MICS_MIC3_X = -0.2145f;
                                        //parametersStruct->P_GEO_MICS_MIC3_Y = -0.1790f;
                                        //parametersStruct->P_GEO_MICS_MIC3_Z = +0.1885f;
                    ...
                    // +-------------------------------------------------------+
                            ...
                            parametersStruct->P_GEO_MICS_MIC4_GAIN = 1.0000f;
                                ...
                                // +-------------------------------------------+
                                        ...
                                        // Define the position of each microphone on the cube (in meters)
                                        // The center of the cube is at the origin
                                        parametersStruct->P_GEO_MICS_MIC4_X = +0.2145f;
                                        parametersStruct->P_GEO_MICS_MIC4_Y = +0.1790f;
                                        parametersStruct->P_GEO_MICS_MIC4_Z = +0.1885f;
                                        //parametersStruct->P_GEO_MICS_MIC4_X = +0.2145f;
                                        //parametersStruct->P_GEO_MICS_MIC4_Y = -0.1790f;
                                        //parametersStruct->P_GEO_MICS_MIC4_Z = +0.1885f;
                    ...
                    // +-------------------------------------------------------+
                            ...
                            parametersStruct->P_GEO_MICS_MIC5_GAIN = 1.0000f;
                                ...
                                // +-------------------------------------------+
                                        ...
                                        // Define the position of each microphone on the cube (in meters)
                                        // The center of the cube is at the origin
                                        parametersStruct->P_GEO_MICS_MIC5_X = +0.2145f;
                                        parametersStruct->P_GEO_MICS_MIC5_Y = -0.1790f;
                                        parametersStruct->P_GEO_MICS_MIC5_Z = -0.1885f;
                                        //parametersStruct->P_GEO_MICS_MIC5_X = +0.2145f;
                                        //parametersStruct->P_GEO_MICS_MIC5_Y = +0.1790f;
                                        //parametersStruct->P_GEO_MICS_MIC5_Z = -0.1885f;
                    ...
                    // +-------------------------------------------------------+
                            ...
                            parametersStruct->P_GEO_MICS_MIC6_GAIN = 1.0000f;
                                ...
                                // +-------------------------------------------+
                                        ...
                                        // Define the position of each microphone on the cube (in meters)
                                        // The center of the cube is at the origin
                                        parametersStruct->P_GEO_MICS_MIC6_X = -0.2145f;
                                        parametersStruct->P_GEO_MICS_MIC6_Y = -0.1790f;
                                        parametersStruct->P_GEO_MICS_MIC6_Z = -0.1885f;
                                        //parametersStruct->P_GEO_MICS_MIC6_X = -0.2145f;
                                        //parametersStruct->P_GEO_MICS_MIC6_Y = +0.1790f;
                                        //parametersStruct->P_GEO_MICS_MIC6_Z = -0.1885f;
                    ...
                    // +-------------------------------------------------------+
                            ...
                            parametersStruct->P_GEO_MICS_MIC7_GAIN = 1.0000f;
                                ...
                                // +-------------------------------------------+
                                        ...
                                        // Define the position of each microphone on the cube (in meters)
                                        // The center of the cube is at the origin
                                        parametersStruct->P_GEO_MICS_MIC7_X = -0.2145f;
                                        parametersStruct->P_GEO_MICS_MIC7_Y = +0.1790f;
                                        parametersStruct->P_GEO_MICS_MIC7_Z = -0.1885f;
                                        //parametersStruct->P_GEO_MICS_MIC7_X = -0.2145f;
                                        //parametersStruct->P_GEO_MICS_MIC7_Y = -0.1790f;
                                        //parametersStruct->P_GEO_MICS_MIC7_Z = -0.1885f;
                    ...
                    // +-------------------------------------------------------+
                            ...
                            parametersStruct->P_GEO_MICS_MIC8_GAIN = 1.0000f;
                                ...
                                // +-------------------------------------------+
                                        ...
                                        // Define the position of each microphone on the cube (in meters)
                                        // The center of the cube is at the origin
                                        parametersStruct->P_GEO_MICS_MIC8_X = +0.2145f;
                                        parametersStruct->P_GEO_MICS_MIC8_Y = +0.1790f;
                                        parametersStruct->P_GEO_MICS_MIC8_Z = -0.1885f;
                                        //parametersStruct->P_GEO_MICS_MIC8_X = +0.2145f;
                                        //parametersStruct->P_GEO_MICS_MIC8_Y = -0.1790f;
                                        //parametersStruct->P_GEO_MICS_MIC8_Z = -0.1885f;
