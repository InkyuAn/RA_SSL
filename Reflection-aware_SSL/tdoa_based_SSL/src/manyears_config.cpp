...
using namespace sound_localization_node;

bool sound_localization_node::parseConfigFile(objOverall& context, const std::string& fn)
{
    ...
    file_param_ptr = fopen(fn.c_str(), "rt");
...
void sound_localization_node::loadParameter(      objOverall&  context,
